...
//        opening geo ip
        driver = DriverManager.getWebDriverWithCustomHeaderLocal(BrowserType.FIREFOX, DeviceType.NEXUS5_ANDROID4, headerElements);
...
//        preparing
        ...
        headerElements.add(new BasicHeaderElement("X-Forwarded-For", expectedResult));
//        opening geo ip
        driver = DriverManager.getWebDriverWithCustomHeaderLocal(BrowserType.CHROME, DeviceType.NEXUS5_ANDROID4, headerElements);
        driver.get("http://ru.smart-ip.net/geoip");
        String actualResult = driver.findElement(By.id("hostname")).getAttribute("value");
        Assert.assertEquals("Incorrect!", expectedResult, actualResult);
    }
